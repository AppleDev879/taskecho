...
const TodoSchema = CollectionSchema(
  ...
  properties: {
    r'category': PropertySchema(
      ...
      name: r'category',
      type: IsarType.byte,
      enumMap: _TodocategoryEnumValueMap,
    ),
...
Todo _todoDeserialize(
  ...
  final object = Todo(
    category: _TodocategoryValueEnumMap[reader.readByteOrNull(offsets[0])] ??
...
P _todoDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_TodocategoryValueEnumMap[reader.readByteOrNull(offset)] ??
          TodoCategory.personal) as P;
    case 1:
...
const _TodocategoryEnumValueMap = {
  'personal': 0,
  'work': 1,
};
const _TodocategoryValueEnumMap = {
  0: TodoCategory.personal,
  1: TodoCategory.work,
};
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, TodoCategory, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
